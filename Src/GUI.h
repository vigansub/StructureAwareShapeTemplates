...
private:
    ...
    void setupCheckBox(int slot, int x, int y, const QString &name, bool *var);
    void setupFloatSlider(int slot, int x, int y, float rangeMin, float rangeMax, const QString &name, float *var);
    void setupIntSlider(int slot, int x, int y, int rangeMin, int rangeMax, const QString &name, int *var);
