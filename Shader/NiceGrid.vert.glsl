...
{	   
    ...
    {
       VertShadowCoord[i] = matLightView[i] * vec4(Position.x, Position.y-offSetY, Position.z, 1);
    }

    gl_Position = matModelViewProjection * vec4(Position.x, Position.y-offSetY, Position.z, 1);
}
